...
public class MainFrame extends JFrame {
    ...
    private JPanel buildDoctorTabs() {
        ...
        ConsultationManagementPanel consultationPanel = new ConsultationManagementPanel(context);
        ...
        ExpertSessionManagementPanel expertSessionPanel = new ExpertSessionManagementPanel(context);
        ...
        WorkProgressPanel workProgressPanel = new WorkProgressPanel(context);
        registerTab(tabs, "工作进度", workProgressPanel);
        CalendarManagementPanel calendarPanel = new CalendarManagementPanel(context);
        registerTab(tabs, "工作日程", calendarPanel);
        ExpertAdvicePanel expertAdvicePanel = new ExpertAdvicePanel(context);
        registerTab(tabs, "专家建议", expertAdvicePanel);
