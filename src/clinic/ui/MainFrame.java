...
import clinic.ui.doctor.FinanceCenterPanel;
import clinic.ui.doctor.InventoryManagementPanel;
...
import clinic.ui.administrator.AuditLogPanel;
...
public class MainFrame extends JFrame {
    ...
    private JPanel buildDoctorTabs() {
        ...
        InventoryManagementPanel inventoryPanel = new InventoryManagementPanel(context, user);
        registerTab(tabs, "库存流水", inventoryPanel);
        ...
        FinanceCenterPanel financePanel = new FinanceCenterPanel(context, user);
        registerTab(tabs, "财务中心", financePanel);
        ...
        if (user.getRole() == Role.ADMIN) {
            AuditLogPanel auditLogPanel = new AuditLogPanel(context);
            registerTab(tabs, "审计日志", auditLogPanel);
        }
        JPanel container = new JPanel(new BorderLayout());
        container.add(tabs, BorderLayout.CENTER);
        return container;
